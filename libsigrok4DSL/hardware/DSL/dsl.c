...
SR_PRIV int dsl_dev_open(struct sr_dev_driver *di, struct sr_dev_inst *sdi, gboolean *fpga_done)
{
    ...
    *fpga_done = (hw_info & bmFPGA_DONE) != 0;
	...
	///////////////////////////////////////////////////////////////////////
	// @Noema 
	// https://github.com/chenmingqiang/DSView/blob/153d1f9ebd55e9825b7ae96c1dfeb4467c6c2021/libsigrok4DSL/hardware/demo/demo.c#L865
	/*
